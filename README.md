...
[![My Skills](https://skillicons.dev/icons?i=java,html,jquery,js,vue,mysql,python,lua,scala,css,docker,eclipse,elasticsearch,idea,kafka,linux,md,maven,nginx,redis,spring,ts,androidstudio)](https://skillicons.dev)
